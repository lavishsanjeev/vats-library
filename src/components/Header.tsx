            ...
            {mounted && (
              <>
                <SignedOut>
                  ...
                  <Link
                    href="/sign-up"
                    className="hidden md:block bg-white text-black hover:bg-gray-100 h-9 px-6 py-2 rounded-full text-sm font-medium transition-all shadow-md"
                  >
                    Join Now
                  </Link>
                </SignedOut>
          ...
          <div className="absolute top-24 left-4 right-4 bg-[#0a0a1f]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl md:hidden flex flex-col gap-4 animate-in slide-in-from-top-5">
            <div className="flex flex-col gap-3 mt-2">
              <SignedOut>
                ...
                <Link
                  href="/sign-up"
                  className="w-full bg-white text-black hover:bg-gray-100 h-10 rounded-xl flex items-center justify-center font-medium"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Join Now
                </Link>
